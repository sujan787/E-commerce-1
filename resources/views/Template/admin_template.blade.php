         ...
         -->
            ...
            <div class="sidebar-wrapper">
                <ul class="nav">
                    ...
                    <li class="nav-item ">
                        <a class="nav-link" href="{{route('order_info')}}">
                    ...
                    <li class="nav-item dropdown ">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <a class="dropdown-item" href="{{route('add_product_index')}}">Add Product</a>
                            <a class="dropdown-item" href="{{route('add_product_view')}}">View Product</a>
                    ...
                    <li class="nav-item dropdown ">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <a class="dropdown-item" href="{{route('add_category_index')}}">Add Category</a>
                            <a class="dropdown-item" href="{{route('add_category_view')}}">View Category</a>
